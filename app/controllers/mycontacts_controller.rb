class MycontactsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @mycontact.save
        format.html { redirect_to mycontact_url(@mycontact), notice: "Mycontact was successfully created." }
  ...
  def update
    respond_to do |format|
      if @mycontact.update(mycontact_params)
        format.html { redirect_to mycontact_url(@mycontact), notice: "Mycontact was successfully updated." }
